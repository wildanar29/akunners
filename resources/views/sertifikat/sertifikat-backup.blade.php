...
<body>
    ...
    <!-- WATERMARK (AMAN DOMPDF) -->
    <!-- <img src="{{ public_path('logo.png') }}"
         style="position:fixed; top:50%; left:50%; width:420px; opacity:0.08; transform:translate(-50%, -50%); z-index:-1;"> -->

    <!-- ORNAMENT (TETAP, TAPI TIDAK MENUTUP QR) -->
        ...
        <table style="width:100%; margin-top:40px; text-align:center;">
            <tr>
                ...
                <td style="width:50%; vertical-align:top;">
                    ...
                    <img
                        src="data:image/png;base64,{{ $barcode_direktur }}"
                        style="width:120px; height:120px; border:1px solid #000;">
                    
                    <div style="margin-top:20px; border-top:1px solid #000; width:300px; margin-left:auto; margin-right:auto; padding-top:6px; font-weight:bold;">
                ...
                <td style="width:50%; vertical-align:top;">
                    ...
                    <img
                        src="data:image/png;base64,{{ $barcode_asesor }}"
                        style="width:120px; height:120px; border:1px solid #000;">
