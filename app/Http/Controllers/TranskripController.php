 ...
 *     description="Mengunggah file, menyimpan file di storage, dan menyimpan detail file ke database.",
 ...
 *                     type="string",
 *                     format="binary",
 *                     description="File yang ingin diunggah (pdf, jpg, jpeg, png)."
 *                 ),
 *               
 *             )
 *         )
 ...
 */
    ...
    public function upload(Request $request)
    {
        ...
        try {    
            ...
            // Cek apakah user sudah memiliki file ijazah
            $existingFile = TranskripModel::where('user_id', $user->user_id)->first();
    
            // Jika file ada, lakukan update
            if ($existingFile) {
                // Hapus file lama dari storage jika ada
                if ($existingFile->path_file && Storage::exists($existingFile->path_file)) {
